...
export const odooRouter = router({
  ...
  purchaseAgreements: publicProcedure.query(async () => {
    ...
    return raw.map((a) => ({
      ...
      incoterm: a.x_studio_purchase_incoterm_condition || null,
      purchaseCurrency: a.x_studio_purchase_currency || null,
  ...
  salesAgreements: publicProcedure.query(async () => {
    ...
    return raw.map((a) => ({
      ...
      studioCustomerId: a.x_studio_customer ? a.x_studio_customer[0] : null,
      studioCustomerName: a.x_studio_customer ? a.x_studio_customer[1] : null,
      ...
      insuranceIncluded: a.x_studio_insurance_included,
      totalQuantityTons: a.x_studio_total_po_quantity_in_tons,
      supplyStartDate: a.x_studio_supply_start_date || null,
      supplyEndDate: a.x_studio_supply_end_date || null,
      notes: a.x_studio_notes || null,
      paymentTerms: a.x_studio_payment_terms || null,
