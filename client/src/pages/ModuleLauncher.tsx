                ...
                <div key={`hero-${stableCardKey}`} className="hero-card" style={{
                  ...
                  <div style={{ position: "relative", zIndex: 1, flexShrink: 0 }}>
                    {!canAccessModule(selected.id) ? (
                      ...
                      <button className="open-btn" onClick={() => { const _m = selected as any; if (_m.externalUrl) { window.location.href = _m.externalUrl; } else { navigate(_m.route || "/dashboard"); } }}>
                        Open Module
